...
public interface IconFace extends Serializable {
  ...
  /**
   * Return the icon file path in apk file. This method is valid only when {@link #isFile()} return
   * true. Otherwise, {@link UnsupportedOperationException} should be thrown.
   */
  String getPath();
}
