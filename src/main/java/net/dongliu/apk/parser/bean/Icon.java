...
public class Icon implements IconFace, Serializable {
  ...
  /**
   * Return the density this icon for. 0 means default icon. see {@link
   * net.dongliu.apk.parser.struct.resource.Densities} for more density values.
   */
  ...
  public String toString() {
    return "Icon{path='" + path + '\'' + ", density=" + density + ", size=" + (data == null ? 0
        : data.length) + '}';
  }
}
