...
public class CertificateMeta {
  ...
  /**
   * the signature algorithm OID string. An OID is represented by a set of non-negative whole
   * numbers separated by periods. For example, the string "1.2.840.10040.4.3" identifies the SHA-1
  ...
  public CertificateMeta(String signAlgorithm, String signAlgorithmOID, Date startDate,
      Date endDate,
