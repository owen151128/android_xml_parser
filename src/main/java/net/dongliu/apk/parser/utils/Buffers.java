...
public class Buffers {
  ...
  /**
   * Return one new ByteBuffer from current position, with size, the byte order of new buffer will
   * be set to little endian; And advance the original buffer with size.
   */
