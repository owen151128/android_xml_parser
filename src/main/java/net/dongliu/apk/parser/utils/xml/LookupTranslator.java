...
class LookupTranslator extends CharSequenceTranslator {
   ...
   * while the value remains as a java.lang.CharSequence. This is because we need the key to support
   * hashCode and equals(Object), allowing it to be the key for a HashMap. See LANG-882.
   *
