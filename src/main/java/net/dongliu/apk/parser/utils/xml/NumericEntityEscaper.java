...
class NumericEntityEscaper extends CodePointTranslator {
   ...
   * the underlying method for the other constructors/builders. The <code>below</code> and
   * <code>above</code> boundaries are inclusive when <code>between</code> is
  ...
  /**
   * <p>Constructs a <code>NumericEntityEscaper</code> between the specified values (inclusive).
   * </p>
   *
  ...
  /**
   * <p>Constructs a <code>NumericEntityEscaper</code> outside of the specified values (exclusive).
   * </p>
   *
