...
public class BerDataValue {
  ...
  /**
   * Returns {@code true} if the content octets of this data value are the complete BER encoding of
   * one or more data values, {@code false} if the content octets of this data value directly
   * represent the value.
   */
  ...
  /**
   * Returns a new reader which returns just this data value. This may be useful for re-reading this
