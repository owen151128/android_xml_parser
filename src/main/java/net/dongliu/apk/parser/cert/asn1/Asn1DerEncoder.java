...
public final class Asn1DerEncoder {
  ...
  /**
   * Compares two bytes arrays based on their lexicographic order. Corresponding elements of the two
   * arrays are compared in ascending order. Elements at out of range indices are assumed to be
   * smaller than the smallest possible value for an element.
   */
