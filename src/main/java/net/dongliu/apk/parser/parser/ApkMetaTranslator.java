  ...
  public void onStartTag(XmlNodeStartTag xmlNodeStartTag) {
    ...
    switch (xmlNodeStartTag.getName()) {
      case "application":
        ...
        if (iconAttr != null) {
          ...
          if (resourceValue instanceof ResourceValue.ReferenceResourceValue) {
            long resourceId = ((ResourceValue.ReferenceResourceValue) resourceValue)
                .getReferenceResourceId();
            List<ResourceTable.Resource> resources = this.resourceTable
        ...
        if (applicationName != null) {
          apkMetaBuilder.setApplicationName(applicationName);
        }
        break;
      case "manifest":
        ...
        apkMetaBuilder
            .setCompileSdkVersionCodename(attributes.getString("compileSdkVersionCodename"));
        apkMetaBuilder
            .setPlatformBuildVersionCode(attributes.getString("platformBuildVersionCode"));
        apkMetaBuilder
            .setPlatformBuildVersionName(attributes.getString("platformBuildVersionName"));
        break;
      case "uses-sdk":
      ...
      case "permission":
        ...
        break;
      case "activity":
        String activity = attributes.getString("name");
        if (activity != null) {
          apkMetaBuilder.addActivity(activity);
        }
        break;
      case "provider":
        String provider = attributes.getString("name");
        if (provider != null) {
          apkMetaBuilder.addProvider(provider);
        }
        break;
      case "service":
        String service = attributes.getString("name");
        if (service != null) {
          apkMetaBuilder.addService(service);
        }
        break;
      case "receiver":
        String receiver = attributes.getString("name");
        if (receiver != null) {
          apkMetaBuilder.addReceiver(receiver);
        }
        break;
    }
