...
/**
 * parse dex file. current we only get the class name. see: http://source.android.com/devices/tech/dalvik/dex-format.html
...
public class DexParser {
  ...
  /**
   * read string pool for dex file. dex file string pool diff a bit with binary xml file or resource
   * table.
   *
   * @param offsets
   * @return
